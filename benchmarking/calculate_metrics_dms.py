...
def prep_data_dms(df: pd.DataFrame, score_type: str, dataset1: str, dataset2: str, labels_file: str) -> T.Tuple[np.ndarray, np.ndarray]:
    """
...
def get_metrics_dms(df_path: str, labels_file_val: str, labels_file_test: str, score_type: str, model_name: str, output_folder: str, dataset1: str = "TRAIN", dataset2_val: str = "VAL", dataset2_test: str = "TEST", epitope_threshold: float = None):
    ...
    y_scores_test, y_true_binary_test = prep_data_dms(df, score_type, dataset1, dataset2_test, labels_file_test)
